...
#
df_nse = pd.read_excel(
    r"D:/A.Otis/LapTrinhPhanTichDuLieu2/dataltptdl2.xlsx")
...
#
df = pd.read_excel(r"D:\A.Otis\LapTrinhPhanTichDuLieu2\dataltptdl2.xlsx")
#
app.layout = html.Div([
        ...
        dcc.Tab(label='Stock Data', children=[
            html.Div([
                ...
                dcc.Dropdown(id='my-dropdown',
                             options=[{'label': 'Financing Promoting Technology', 'value': 'FPT'},
                                      {'label': 'Vietinbank', 'value': 'CTG'},
